...
if ! command -v solana &> /dev/null; then
    solana_version="v1.14.7"  # Set your desired Solana CLI version here
    execute_and_prompt "Installing Solana CLI (version $solana_version)..." "sh -c \"$(curl -sSfL https://release.solana.com/$solana_version/install)\""
